...
public class Solution
{
    ...
    public static HashMap<String, Date> createMap()
    {
        ...
        map.put("Stallone2", new Date("JULY 12 1980"));
        map.put("Stallone3", new Date("AUGUST 15 1980"));
        map.put("Stallone4", new Date("JANUARY 21 1980"));
        map.put("Stallone5", new Date("MAY 1 1980"));
        map.put("Stallone6", new Date("MAY 31 1980"));
        map.put("Stallone7", new Date("JUNE 21 1980"));
